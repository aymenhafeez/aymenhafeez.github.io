...
to generate the data being plotted, as well as creating a figure and 3D axes:
...
> The animation traces the knot over 1000 frames with $t$ going from $0$ to
> $2\pi$. By setting `rotation_speed=0.36` the plot rotates by $0.36^\circ$
> each frame. This ensures that over the 1000 frames the axes completes a full
...
<a href="/posts/animplotlib/">Back to examples</a>
