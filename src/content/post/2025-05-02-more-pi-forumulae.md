...
See <a href="https://aymenhafeez.github.io/posts/2022-11-28-pi-prime-numbers/">this
post</a> on the Riemann zeta function at even values for a short overview on expressing
functions in this form, or look into the Weierstrass factorisation theorem for a more
rigorous explanation. Letting $x=\frac{1}{2}$ gives
