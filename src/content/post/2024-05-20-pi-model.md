...
description: "Deriving expressions to model the relation between photosynthetic rate and"
tags: []
---
...
![P-I relationship diagram](/images/light.png)
...
$$
When \ \ P = 0, \ \frac{\text{d} P}{\text{d} I} = \frac{P_m}{I_k}
$$

$\qquad \qquad \qquad Condition\;2$

$$
\lim_{P \to P_m} \frac{\text{d} P}{\text{d} I} = 0
$$
...
$$
For \ \ 0 < P < P_m, \ 0 < \frac{\text{d} P}{\text{d} I} < \frac{P_m}{I_k}
$$
...
$$
  \frac{\text{d} P}{\text{d} I} = \alpha(P_{m} - P),
$$

$$
 \alpha \int \text{d} I = \int \frac{\text{d} P}{P_{m} - P},
$$
...
$$
  \frac{\text{d} P}{\text{d} I} = \frac{P_{m}}{I_{k}} + a_{1}P + a_{2}P^{2},
$$
...
$$
  \begin{align*}
    \frac{\text{d} P}{\text{d} I} &= P_{m}\alpha - (\alpha + a_{2}P_{m})P + a_{2}P^{2}, \\
...
Setting the derivative of $\frac{\text{d} P}{\text{d} I}$ equal to zero, we can find that
the maximum slope occurs at $P = \frac{\alpha + a_{2}P_{m}}{2a_{2}} =
\frac{-a_{1}}{2a_{2}}$. And so, the maximum slope can be given by

$$
  \left( \frac{\text{d} P}{\text{d} I} \right)_{max} = \alpha P_{m} +
...
for $\frac{\text{d} P}{\text{d} I}$ we defined above as

$$
  \frac{\text{d} P}{\text{d} I} = \alpha(P_{m} - P)\left( 1 + \frac{P}{P_{m}} \right).
$$
...
![Photosynthesis model figure](/images/fig.png)
