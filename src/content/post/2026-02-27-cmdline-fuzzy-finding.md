...
For those who want to final result without the walkthrough and explanation, it can be
found [here](https://github.com/aymenhafeez/dotfiles/blob/master/nvim/plugin/cmdline.lua).
