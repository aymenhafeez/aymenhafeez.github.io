...
see from the expression for $(\dd P/\dd I)_{max}$ that the maximum slope will
exceed $\alpha P_{m}$, except for when $a_{1} = 0$. When this is the case,
$a_{2} = -\frac{\alpha}{P_{m}}$ and $\epsilon = 1$. We can, therefore, write
the equation for $\frac{\dd P}{\dd I}$ we defined above as
